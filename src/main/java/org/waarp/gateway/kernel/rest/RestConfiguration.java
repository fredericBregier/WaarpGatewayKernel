...
public class RestConfiguration {
   ...
   * equivalent POST, GET, PUT, DELETE) methods
   * (2^0 for active, 2^1 as Create/POST, 2^2 as Read/GET, 2^3 as Update/PUT,
   * 2^4 as Delete/DELETE)
   */
  ...
  public String toString() {
    String result =
        ...
        REST_SSL + ", time: "
        + REST_TIME_LIMIT +
        ", authent:" + REST_AUTHENTICATED + ", signature: " + REST_SIGNATURE +
        ", handlers: [";
