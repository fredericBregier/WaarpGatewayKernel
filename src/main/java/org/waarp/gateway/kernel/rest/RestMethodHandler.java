...
public abstract class RestMethodHandler {
  ...
  /**
   * @param name name associated with this Method Handler (to enable some
   *     HashMap or Enum classification)
  ...
  /**
   * Check the session (arguments, result) vs handler correctness, called before
   * any BODY elements but after URI and
   * HEADER.
   *
   * @param handler
   * @param arguments
