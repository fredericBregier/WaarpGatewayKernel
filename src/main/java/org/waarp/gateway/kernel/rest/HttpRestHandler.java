...
public abstract class HttpRestHandler
  ...
  /**
   * To be used for instance to check correctness of connection<br> Note that
   * ARG_METHOD is only set from current
   * request. It might be also set from URI or HEADER and therefore should be
   * done in this method.
   *
   * @param ctx
   *
  ...
  public static enum METHOD {
     ...
     * process, unless that text happens to be
     ...
     * request/response chain identified by the Request-URI. This method allows
     ...
     * that can dynamically switch to being
     * a tunnel
     */
